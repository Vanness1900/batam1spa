...
function ImageContainer({ 
    ...
    aspectRatio = "1/1", 
    lgAspectRatio,
    type = "modal", // "static", "hover", "modal", "service"
    onClick,
    className = "",
    description,
    included,
    ...
    const updatePax = (change) => {
        setPax(prev => Math.min(8, Math.max(1, prev + change))); // prevent negative pax
    };
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        // handle booking form logic here
        console.log("Booking submitted:", { pax });
    };
        ...
        <div className={`relative w-full mx-auto overflow-hidden rounded-2xl ${className}`}>
            ...
            `}>
                <img 
                    ...
                    onClick={handleClick}
                />
                {/* Overlay gradient for better border visibility */}
                {/* <div className="absolute inset-0 bg-gradient-to-br from-amber-400/10 via-transparent to-amber-600/10 pointer-events-none"></div> */}
            </div>
                ...
                <ImageModal open={modalOpen} onClose={() => setModalOpen(false)}>
                    <div className="flex space-x-8">
                        <div className="relative w-[60vw] h-[90vh] bg-c-black-1 rounded-2xl shadow-2xl grid grid-cols-3">
                            ...
                            <div className="col-span-2 p-8 overflow-y-auto space-y-12">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <span className="flex justify-between">
                                        ...
                                        <p className="text-c-white-1">Rp. {lprice},00</p>
                                    </span>
                                    <span className="flex justify-between">
                                        <p className="text-c-white-1">Tourist</p>
                                        <p className="text-c-white-1">Rp. {tprice},00</p>
                                    </span>
                                </div>
                            ...
                            <form onSubmit={handleSubmit} className="relative bg-c-black-1 w-[20vw] h-[90vh] rounded-2xl shadow-2xl flex flex-col place-content-between p-8">
                                <div className="space-y-4">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        >
                                            <option value="30" className="bg-c-black-1">30 minutes</option>
                                            <option value="60" className="bg-c-black-1">60 minutes</option>
                                            <option value="90" className="bg-c-black-1">90 minutes</option>
                                            <option value="120" className="bg-c-black-1">120 minutes</option>
                                        </select>
                                    </div>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="relative cursor-pointer" onClick={() => document.querySelector('input[name="date"]').showPicker()}>
                                            <input 
                                                ...
                                                max={maxDate}
                                            />
                                            {/* Custom white calendar icon on the right */}
                                ...
                                <div className="flex flex-col space-y-4 w-full">
                                    ...
                                    <Link to="/Cart" >
                                        <Button text="Continue To Payment" className="w-full"/>
                                    </Link>
                                </div>
                            </form>
                        </div>
